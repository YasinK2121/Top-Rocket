...
public class CUIColorPicker : MonoBehaviour
{
    ...
    {
        var satvalGO = GO("/MainMenuPanelCanvas/MainMenuPanel/PaintPanel/ColorPick/Colors/SaturationValue");
        var satvalKnob = GO("/MainMenuPanelCanvas/MainMenuPanel/PaintPanel/ColorPick/Colors/SaturationValue/Knob");
        var hueGO = GO("/MainMenuPanelCanvas/MainMenuPanel/PaintPanel/ColorPick/Colors/Hue");
        var hueKnob = GO("/MainMenuPanelCanvas/MainMenuPanel/PaintPanel/ColorPick/Colors/Hue/Knob");
